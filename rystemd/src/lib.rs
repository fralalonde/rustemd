//! rystemd — a systemd init reimplementation in Rust.
//!
...
//!
//! The `systemctl`-compatible CLI lives in the sibling `rystemctl` crate,
...
pub const VERSION: &str = env!("RYSTEMD_VERSION");
