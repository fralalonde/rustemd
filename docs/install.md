...
## Experimental PID 1 use

The canonical rpm-ostree procedure is maintained in the
[rystemd handbook](https://rystemd.github.io/pid1.html). It preserves the stock
init links, systemctl binary, initramfs, and previous ostree boot entry.
