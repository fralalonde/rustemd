...
ln -s rustemd "$PKG_ROOT/bin/systemctl"
"$BIN_DIR/rustemd" completions bash       > "$PKG_ROOT/completions/rustemd.bash"
"$BIN_DIR/rustemd" completions zsh        > "$PKG_ROOT/completions/_rustemd"
"$BIN_DIR/rustemd" completions fish       > "$PKG_ROOT/completions/rustemd.fish"
"$BIN_DIR/rustemd" completions powershell > "$PKG_ROOT/completions/rustemd.ps1"
"$BIN_DIR/rustemd" completions nushell    > "$PKG_ROOT/completions/rustemd.nu"
...
install -m 0644 "$PKG_ROOT/completions/rustemd.bash" "$DEB_ROOT/usr/share/bash-completion/completions/rustemd"
install -m 0644 "$PKG_ROOT/completions/_rustemd"     "$DEB_ROOT/usr/share/zsh/site-functions/_rustemd"
install -m 0644 "$PKG_ROOT/completions/rustemd.fish" "$DEB_ROOT/usr/share/fish/vendor_completions.d/rustemd.fish"
